...
func main() {
	...
	corsHandler := handlers.CORS(
		handlers.AllowedOrigins([]string{"http://himtalks.japaneast.cloudapp.azure.com", "https://himtalks-frontend.vercel.app", "https://himtalks-admin.vercel.app"}), // Ganti * dengan domain FE
